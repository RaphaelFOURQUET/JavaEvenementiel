 ...
 * 
 */
package fr.adaming.mvc.model;

import java.util.ArrayList;

import fr.adaming.mvc.Observable;
import fr.adaming.mvc.Observer;
...
public abstract class AbstractModel implements Observable {
	...
	public void notifyObserver(String str) {
		if(str.matches("^0[0-9]+"))	//RFRF : Commence par 0 et au moins une fois un digit (de 0 à 9)
